package com.rectus29.beertender.web.panel.hc.hcsplinepanel;
...
public abstract class HcSplinePanel extends Panel {
    ...
    public HcSplinePanel(String id) {
        super(id);
        init();
    }

    public HcSplinePanel(String id, String width, String height) {
        super(id);
        this.height = height;
        this.width = width;
        init();
    ...
    public HcSplinePanel(String id, String width, String height, boolean legend) {
        super(id);
        this.height = height;
        this.width = width;
        this.legend = legend;
    ...
    private String getJS() {
        ...
        if (!WebSession.get().getClientInfo().getUserAgent().toLowerCase().contains("ipad") && !WebSession.get().getClientInfo().getUserAgent().toLowerCase().contains("iphone"))
            graph += "zoomType: 'xy', \n";
        graph += "               defaultSeriesType: 'spline',                                                                                                  \n" +
                "	    	    spacingRight: 20,                                                                                                          \n" +
                "               //animation: false                                                                                                          \n" +
                "	        },                                                                                                                              \n" +
