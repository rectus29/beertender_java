...
//    private IserviceMail serviceMail;
    ...
    public RestorePasswordPage(PageParameters parameters) {
        ...
        final PasswordTextField mdp1 = new PasswordTextField("mdp1", new PropertyModel(this, "mdp1String"));
        mdp1.add(new PasswordPolicyValidator());
        form.add(mdp1);
        final PasswordTextField mdp2 = new PasswordTextField("mdp2", new PropertyModel(this, "mdp2String"));
        form.add(mdp2);
