...
public class EnrollmentPage extends Page {
	...
	protected void onInitialize() {
		...
		Form form = new Form("enrollForm"){
			...
			protected void onInitialize() {
				super.onInitialize();
				add((mdp1 = new PasswordTextField("mdp1", new PropertyModel<String>(EnrollmentPage.this, "mdp1String"))).add(new PasswordPolicyValidator()));
				add((mdp2 = new PasswordTextField("mdp2", new PropertyModel<String>(EnrollmentPage.this, "mdp2String"))).add(new PasswordPolicyValidator()));
